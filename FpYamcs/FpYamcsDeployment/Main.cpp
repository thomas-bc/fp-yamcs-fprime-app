...
#include <FpYamcs/FpYamcsDeployment/Top/FpYamcsDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    FpYamcs::setupTopology(inputs);
    FpYamcs::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    FpYamcs::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
